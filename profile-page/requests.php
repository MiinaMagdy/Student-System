    ...
    <tbody>
        <?php
            ...
            while ($row = mysqli_fetch_assoc($query)) {
                ...
                echo '<td><a href="accept.php?id=' . $row['id'] . '"><img src="checked.png" alt="edit" class="icon-tools"></a></td>';
                echo '<td><a href="delete.php?id=' . $row['id'] . '"><img src="cancel.png" alt="delete" class="icon-tools"></a></td>';
                echo "</tr>";
            }
        ?>
    </tbody>
