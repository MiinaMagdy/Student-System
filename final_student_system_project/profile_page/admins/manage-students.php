...
<button id="btnAddStudent" class="add-student-btn profileBtn btn-dark">Add Student</button>
    ...
    <tbody>
        <?php
            ...
            while ($row = mysqli_fetch_assoc($query)) {
                ...
                echo '<td><a href="edit.php?id=' . $row['id'] . '"><img src="assets/images/edit.png" alt="edit" class="icon-tools"></a></td>';
                echo '<td><a href="delete.php?id=' . $row['id'] . '"><img src="assets/images/delete.png" alt="delete" class="icon-tools"></a></td>';
                echo "</tr>";
            }
        ?>
    </tbody>
