...
<button id="btnAddStudent" class="add-student-btn btn btn-dark">Add Student</button>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <div class="add-student-container">
                ...
                <div class="column-flex">
                    ...
                    <input class="add-student-input-field" required type="date" name="birthdate">
                </div>
                <div class="column-flex">
    ...
    <tbody>
        <?php
            ...
            while ($row = mysqli_fetch_assoc($query)) {
                ...
                echo '<td><a href="edit.php?id=' . $row['id'] . '"><img src="pictures/edit.png" alt="edit" class="icon-tools"></a></td>';
                echo '<td><a href="delete.php?id=' . $row['id'] . '"><img src="pictures/delete.png" alt="delete" class="icon-tools"></a></td>';
                echo "</tr>";
            }
        ?>
    </tbody>
...
<script src="addStudentModal.js"></script>