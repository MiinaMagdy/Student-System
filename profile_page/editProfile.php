<?php
    ...
    if(isset($_POST['submit2'])){
        ...
        $sql = "UPDATE $check SET `name`='$name', `phone`='$phone', `address`='$address', `email`='$email', `password`='$password' WHERE id = " . $_GET['id'];
        if (mysqli_query($conn, $sql)) {
            $check_file = ($check == "students" ? "students/student.php" : "admins/admin.php");
            header("Location: $check_file");
